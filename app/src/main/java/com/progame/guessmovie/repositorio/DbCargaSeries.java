...
public class DbCargaSeries {
    ...
    public void inserirFases(){
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Daredevil");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "QBYZDEUDTEXRQBXPPWVATUZILW");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QQWWTTYUUPPZZXXBB");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "**DAREDEVIL***************");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "lucifer");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "JYKIASZPWQRNXBTVOLCFEWHUMT");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QWASZXVBNMKJHOPYTW");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***LUCIFER****************");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Punisher");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "ESLJRZBHZXIFVXNBGKPU");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXXVBBLKJGF");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "*PUNISHER***********");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "The XFiles");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "TFZCCVESBNILZMKKJHEX");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZCCVBNMKKJ");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "THE*XFILES**********");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "My wife and kids");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "MXXQIFQTTYKIDSZZAWEDNUUOPP");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXXQQTTUUOPP");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***MY*WIFE*****AND*KIDS**");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Everybody hates Chris");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "QWHEYRXJERSSTKEHPDPOCYBAIV");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QQWPPPJXK");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "**EVERYBODY***HATES*CHRIS*");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "24 hours");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "VC78OZX2MSB5XRHLB4UZ");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "578ZZXXCVBBMLKKJGFD");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "*24*HOURS***********");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Mars");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "GMRQOISQJWPLTKYTHAUW");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QWYUIIOPLKKJHGFDTZZX");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***MARS*************");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Unfortunate Events");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "AXRESNKTBKNEZFUJNETMUZTVJL");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXBMKKJJL");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "*UNFORTUNATE****EVENTS***");
        ...
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "APBRJZPZVCWJINAEKONEHLTGSX");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXVJJPPHT");
        ...
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "IHGCGAGDIWKWRUQLYQOHNOKKET");
        ...
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "JWPAWLPOQEITHEYQFTRGJIYKCU");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QQWWRTTYYOIIPPJHJF");
        ...
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "BKZHSVMJKARLXMCTKNOGSVEZPO");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXCVVBMMLKKJKG");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Iron Fist");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "XGGJOMFKZNDMSVRLZTJDXIIHKC");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXXCVKMMLKJJHGGDD");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "**IRON*FIST***************");
        values.put(PostFase.PostEntry.COLUMN_NIVEL, 68);
        newRowId = db.insert(PostFase.PostEntry.TABLE_NAME, null, values);

        values.put(PostFase.PostEntry.COLUMN_TITULO, "Lost in Space");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "serie");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "JWXNOGQSXLIPAZWHJQKTEZFCSU");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXXQQWWUKJJHGF");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***LOST*IN*******SPACE****");
