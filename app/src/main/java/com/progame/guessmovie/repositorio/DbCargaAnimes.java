...
public class DbCargaAnimes {
    ...
    public void inserirFases(){
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "pokemon");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "anime");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "WQCAAIETUZSOWJYWAPAMBKONIQ");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "WQCAITUZSJYB");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***POKEMON****************");
        values.put(PostFase.PostEntry.COLUMN_NIVEL, 8);
        newRowId = db.insert(PostFase.PostEntry.TABLE_NAME, null, values);

        values.put(PostFase.PostEntry.COLUMN_TITULO, "Captain Tsubasa");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "anime");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "KSWKPKAJLTOJQSUABTWIAQARCN");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QQWWRKOLKKJJ");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "***CAPTAIN******TSUBASA***");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Saint Seiya");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "anime");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "SAINEQQWWZTSZYAXXVBK");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "QQWWZZXXVBK");
        values.put(PostFase.PostEntry.COLUMN_RESPOSTA, "SAINT*SEYA**********");
        ...
        values.put(PostFase.PostEntry.COLUMN_TITULO, "Sakura Card Captors");
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "anime");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "AVPZRLBACSKAAVTXOHRUJCSDZR");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_ERRADAS, "ZZXVVBLJH");
        ...
        values.put(PostFase.PostEntry.COLUMN_CATEGORIA, "anime");
        values.put(PostFase.PostEntry.COLUMN_LETRAS_EMBARALHADAS, "LIFKAHCVIGDWXLINIRMJSBQZKC");
